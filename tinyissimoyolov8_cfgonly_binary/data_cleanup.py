...
def clean_speciesnet_data(speciesnet_file):
    ...
    # save to json
    with open('speciesnet_labels_cleaned/speciesnet_labels_b2_cleaned.json', 'w', encoding='utf-8') as f: # data_labels/speciesnet_cleaned.json
        json.dump(new_data, f, indent=2)
...
if __name__ == "__main__":
    ...
    SPECIESNET_FILE = "../speciesnet_labels/speciesnet_labels_b2.json"

    # ean_jrct_data(JRCT_FILE)
